...
/**
 * Test-scoped ARGB-to-BoofCV conversion utility for the BoofCV adapter skeleton.
 */
final class BoofCvArgbToPlanarRgbConverter {
    ...
    /**
     * Converts retained row-major ARGB pixels into BoofCV planar RGB bands with explicit conversion metadata.
     *
    ...
    /**
     * Copied BoofCV image plus the metadata needed to explain how ARGB pixels were converted.
     *
